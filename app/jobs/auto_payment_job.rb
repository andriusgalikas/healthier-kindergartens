class AutoPaymentJob < ActiveJob::Base
    ...
    def perform *args
        ...
        @job_subscriptions.each do |subitem|
            unless subitem.transaction_id.nil?
                ...
                days = 0
                unless subitem.payment_mode
                  case subitem.payment_mode.until
                  when 'week'
    ...
    def pay_subscription subscription
        ...
        @job_deposit_plan = Plan.where(plan_type: 0, language: I18n.locale.upcase).first
        ...
        @job_transaction.card_num = @job_plan.card_number
